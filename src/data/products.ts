...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Combo Fire",
    price: 49.90,
    description: "Fire Classic, batata frita média, 4 onion rings e refrigerante 500ml.",
    longDescription: "O Combo Fire é perfeito para quem quer experimentar um pouco de tudo! Acompanha nosso Fire Classic com 180g de hambúrguer suculento, uma porção média de batatas fritas crocantes, 4 deliciosos onion rings e refrigerante de sua escolha (500ml). A combinação ideal para uma refeição completa, com sabor e variedade em cada mordida.",
    image: "https://res.cloudinary.com/dkndyevos/image/upload/v1744502258/%D0%9A%D0%9E%D0%9C%D0%91%D0%9E_%D0%A1_%D0%91%D0%A3%D0%A0%D0%93%D0%95%D0%A0%D0%9E%D0%9C-%D0%A7%D0%98%D0%97_k8mx5k.jpg",
    category: "Combos",
    isFeatured: true,
    ingredients: ["Fire Classic", "Batata frita média", "4 Onion rings", "Refrigerante 500ml"],
