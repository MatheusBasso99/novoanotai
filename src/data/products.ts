...
export const products: Product[] = [
  {
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/a6pVgd2r9WbZk7B",
    slug: "combo-fire",
    isCombo: true
  },
  {
    ...
    price: 43.90,
    description: "2 Fire Classic (180g), batata frita grande e refrigerante 1L.",
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/nOzxZooep7VZJ07",
    slug: "combo-erupcao",
    isCombo: true,
  },
  {
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/kYL6geWe97vZrKM",
    slug: "combo-familia",
    isCombo: true
  },
  {
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/6YQPgjnlPWLgpxz",
    slug: "fire-classic",
  },
  {
    id: "combo-2",
    ...
    tags: ["Combo", "Picante"],
    checkoutLink: "https://pay.comprasegurafireburguer.pro/lqv130y24MWZxbj",
  ...
  },
  {
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/PyE2Zy8OpQn3qRb",
  ...
  },
  {
    ...
    name: "Volcano",
    price: 31.90,
    description: "Hambúrguer 180g, pimenta jalapeño, queijo pepper jack, cebola e molho volcano.",
    longDescription: "O Volcano é para quem gosta de aventura! Com um hambúrguer de 180g, fatias de pimenta jalapeño, queijo pepper jack derretido, cebola crispy crocante e nosso exclusivo molho volcano de pimentas selecionadas. Servido em um pão brioche especial com gergelim preto. Um verdadeiro vulcão de sabores intensos que vai fazer seu paladar entrar em erupção!",
    image: "https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?q=80&w=500",
    category: "Hambúrgueres",
    isFeatured: true,
    ingredients: ["Pão brioche com gergelim preto", "Hambúrguer 180g", "Pimenta jalapeño", "Queijo pepper jack", "Cebola crispy", "Molho volcano"],
    tags: ["Extra picante", "Especialidade da casa"],
    checkoutLink: "https://pay.comprasegurafireburguer.pro/P5LNZ8zQvw2gaRy",
    slug: "volcano",
  },
  {
    id: "burger-4",
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/bz5KZbV7vAKZ7dL",
  ...
  },
  {
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/PyE2Zy8Opq53qRb",
    slug: "fire-especial",
  },
  {
    id: "burger-6",
    ...
    checkoutLink: "https://pay.comprasegurafireburguer.pro/z0qn35dxQmvg98m",
    slug: "fire-atomic",
  },
];
